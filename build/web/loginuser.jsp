	...
	<body>
		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-xs-12">
					<br>
					<p><strong>eObserve</strong> is a simulator which simulates values of electric current.</p>
					<p><strong>(The) Concept is </strong></p>
					<!-- <span class="glyphicon glyphicon-ok" aria-hidden="true"></span> --><p>There are 4 providers of electrical power.</p>
					<p>The value of electricity changes every 1 hour.</p>
					<p>The target of this application is to inform the consumer which provider </p>
					<p>has the lower value of electricity every single moment.</p>
					<br>
